...
class Req(ReqDllmMixin):
    ...
    def __init__(
        ...
        # Distinct from skip_radix_cache_insert (a disaggregation- and
        # beam-search-internal flag that also suppresses the chunked-prefill
        # bookkeeping); this one only suppresses publication. See
        # mem_cache/common.py.
